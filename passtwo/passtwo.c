...
void main()
{
    ...
    while (strcmp(opcode, "END") != 0)
    {
        ...
        {
            // If found the opcode, generate the machine code for instruction
        ...
        /*
            if BYTE, then convert the corresponding ascii characters to their ascii values
        ...
        */
        ...
        /*
            If max size of text record reached, then store the text record in file
